...
CREATE TABLE IF NOT EXISTS "Kundeordre" (
	...
	FOREIGN KEY("ruteID", "dato") REFERENCES "TogruteForekomst" ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS "HarKupeBillett" (
	...
	"ruteID"	INTEGER NOT NULL,
	"dato"	INTEGER NOT NULL,
	"reiserFra" TEXT NOT NULL,
	"reiserTil" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Kupebillett" (
	...
	FOREIGN KEY("vognID", "kupeNR", "sengNR") REFERENCES "Seng" ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "SetebillettIOrdre" (
	...
	"delstrekningID" INTEGER NOT NULL,
	"ordreNR" INTEGER NOT NULL,
	PRIMARY KEY("billettID","seteNR","vognID","delstrekningID", "ordreNR"),
	FOREIGN KEY("ordreNR") REFERENCES "Kundeordre" ON UPDATE CASCADE ON DELETE CASCADE,
