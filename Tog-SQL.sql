...
CREATE TABLE IF NOT EXISTS "Seng" (
	...
	"sengNR"	INTEGER NOT NULL,
	"kupeNR"	INTEGER NOT NULL,
	FOREIGN KEY("kupeNR") REFERENCES "Sovekupe"("kupeNR") ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY("vognID") REFERENCES "Sovekupe"("vognID") ON UPDATE CASCADE ON DELETE CASCADE,
